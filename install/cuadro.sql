...
('footer_bottom', '<p>Strona pokazowa skryptu dla zdjęć i film&oacute;w Cuadro</p>\r\n<p><small>Web script for pictures and movies Cuadro v1.9.1 Project 2018 - 2023 by <a href=\"https://itworksbetter.net\" target=\"_blank\" title=\"Creating websites\">IT Works Better</a></small></p>'),
...
('rss', '1'),
('rodo_alert', '0'),
('rodo_alert_text', '<p>Szanowny użytkowniku,<br />pragniemy Cię poinformować, że nasz serwis internetowy może personalizować treści marketingowe do Twoich potrzeb. W związku z tym danymi osobowymi, kt&oacute;re przetwarzamy są np. Tw&oacute;j adres IP, dane pozyskiwane na podstawie plik&oacute;w cookies lub podobnych mechanizm&oacute;w na Twoim urządzeniu o ile pozwolą one na zidentyfikowanie Ciebie.&nbsp;<br />Więcej informacji odnośnie przetwarzania danych osobowych znajdziesz w naszej <a href="/info/1,polityka-prywatnosci">Polityce Prywatności.</a></p><p>Jest to demo skryptu, w kt&oacute;rym dostęp do Panelu Administratora mają wszyscy użytkownicy. Dlatego też w panelu mogą zobaczyć Tw&oacute;j login, adres IP i inne dane (bez adresu email) jeśli zarejestrujesz się na stronie lub podejmiesz inne działanie. Prosimy mieć to na względzie.</p>'),
